...
class FairseqTask(object):
    ...
    def can_reuse_epoch_itr(self, dataset):
        ...
        return getattr(dataset, "can_reuse_epoch_itr_across_epochs", False) and not self.has_non_static_dataset()
    ...
    def get_batch_iterator(
        ...
        reuse_dataloader = getattr(self.cfg, "reuse_dataloader", True) and not self.has_non_static_dataset()
        persistent_workers = getattr(self.cfg, "persistent_workers", True)
        rebuild_batches = getattr(self.cfg, "rebuild_batches", False) or self.has_non_static_dataset()
