...
from fairseq.data import jamo_utils
from fairseq.data import round_trip_byte_encoder
...
def post_process(sentence: str, symbol: str):
    ...
    elif "sentencepiece_" in symbol:
        sentence = sentence.replace(" ", "").replace("\u2581", " ").strip()

        if "compat" in symbol:
            sentence = jamo_utils.recompose_compat(sentence)
        elif "positional" in symbol:
            sentence = jamo_utils.recompose_positional(sentence)
        elif "byte" in symbol:
